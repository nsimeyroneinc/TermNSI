...
!!! example "Exercice {0}.1"
    === "Énoncé" 
        --8<-- "docs/BAC/files/{0}_1/enonce.md"

    === "Correction"
        --8<-- "docs/BAC/files/{0}_1/correction.md"
...
!!! example "Exercice {0}.2"
    === "Énoncé" 
        --8<-- "docs/BAC/files/{0}_2/enonce.md"

    === "Correction"
        --8<-- "docs/BAC/files/{0}_2/correction.md"
